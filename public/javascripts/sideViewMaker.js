...
async function loadPlots() {
    ...
    var y = d3.scaleLinear()
        ...
        .range([height, 0]);
    svg.append("g")
        .attr("transform", "translate(-20,0)") //TODO fix it
        .call(d3.axisLeft(y));
    svg.append("text")
...
function addPoints(svg, data){
    ...
    var point = first[i];
        ...
        .attr("cy", function (d) { return height - d.Y/SCALE_FACTOR; } )
        .attr("r", 1.5)
        .style("fill", "#00ff48")
...
function animate(svg,body_label, data){
    ...
    svg.selectAll("#"+body_label)
      .transition()
      //.delay(function(d,i){return(i*3)})
      .duration(10)
      .attr("cx", function (d) {return marker.X/SCALE_FACTOR; } )
      .attr("cy", function (d) {return height - marker.Y/SCALE_FACTOR;} )
...
function getFilteredData(data){
    return data.filter(function(mark){
        return (mark.Participant === "2014001"
        && mark.Speed === "1" && mark.Trial === "1")
    })
}
